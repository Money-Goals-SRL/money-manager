...
function TermConditions() {
	return (
		<>
			...
			<h4>1. Definizioni</h4>
			<p>
				Per consentire una completa comprensione e accettazione dei presenti termini e
				condizioni, i seguenti termini, al singolare e al plurale, avranno il significato di
				seguito indicato: Titolare: Money Goals SRL a socio unico, con sede legale in via
				Resistenza 3, 41014, Castelvetro di Modena (MO), Italia, P.IVA IT04001560368,
				capitale sociale 10.000,00 €. Sito: il sito web
				https://money-goals-srl.github.io/money-manager, gestito dal Titolare, un sito
				informativo su calcolatori economici e matematici Contenuti: i contenuti e/o servizi
			...
			<p>
				...
				di titolarità del Titolare o dei suoi licenziatari e sono protetti dalle leggi
				vigenti sui marchi e dai relativi trattati internazionali. Eventuali riproduzioni in
				qualunque forma dei testi esplicativi e dei contenuti del Sito, qualora non
				autorizzate, saranno considerate violazioni del diritto proprietà intellettuale ed
			...
			<p>
				...
				incluse le eventuali spese legali sostenute per difendersi in giudizio, che
				dovessero sorgere a fronte di danni provocati ad altri Utenti o a terzi, in
				relazione ai Contenuti caricati o alla violazione dei termini di legge o dei termini
			...
			<p>
				Il Titolare non potrà essere considerato responsabile per il mancato o ritardato
				adempimento delle proprie obbligazioni, per circostanze al di fuori del controllo
				ragionevole del Titolare dovuti ad eventi di forza maggiore o, comunque, ad eventi
				imprevisti ed imprevedibili e, comunque, indipendenti dalla volontà quali, a titolo
				esemplificativo e non esaustivo, guasti o interruzioni alle linee telefoniche o
			...
			<p>
				Il Sito potrebbe contenere collegamenti a siti di terzi. Il Titolare non esercita
			...
			<h4>9. Rinuncia</h4>
			<p>
				Nessuna rinuncia da parte di ciascuna parte ad un articolo delle presenti Condizioni
				sarà efficace a meno che non sia espressamente dichiarato di essere una rinuncia e
				venga comunicata per iscritto.
			</p>
			<h4>10. Invalidità di singole clausole</h4>
			<p>
				Qualora una qualsiasi disposizione delle presenti Condizioni risultasse illegale o
				non valida, essa non verrà considerata come parte delle Condizioni e questo non
				influirà sulle disposizioni rimanenti che continueranno ad essere valide nella
				misura massima consentita dalla legge.
			</p>
			<h4>11. Privacy</h4>
			<p>
				La tutela e il trattamento dei dati personali avverranno in conformità
				all'Informativa Privacy, che può essere consultata alla pagina della
			...
			<p>
				Ai presenti termini e condizioni, sono allegati due ulteriori documenti che
				integrano e fanno parte interamente di queste condizioni:
				<li>
					la <strong>politica sulla privacy</strong>: questo documento specifica come
					vengono trattate le informazioni fornite dagli utenti sul sito web
				</li>
				<li>
